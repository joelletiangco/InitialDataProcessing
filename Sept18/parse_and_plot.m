...
for i = 1:1:length(files.force)
    ...
    data(i).orig = array2table(temp_ang, 'VariableNames', VarNames);
    data(i).deriv1 = array2table(temp_vel, 'VariableNames', VarNames);
    data(i).deriv2 = array2table(temp_acc, 'VariableNames', VarNames);
