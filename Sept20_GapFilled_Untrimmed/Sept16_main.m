...
% vicon files (right now this is just hip, knee and ankle angles in x, y, z) and
% then plots them. 
...
%     R_SS_S = parse_csv_and_plot(S_SS_R_files, opts, [subject{i} ' Shod Side Lunges Right Side'], Sdir);
%     L_SS_S = parse_csv_and_plot(S_SS_L_files, opts, [subject{i} ' Shod Side Lunges Left Side'], Sdir);
...
%     R_SS_OR = parse_csv_and_plot(OR_SS_R_files, opts, [subject{i} ' Orthotics Side Lunges Right Side'], ORdir);
%     L_SS_OR = parse_csv_and_plot(OR_SS_L_files, opts, [subject{i} ' Orthotics Side Lunges Left Side'], ORdir);
...
%     R_SS_BF = parse_csv_and_plot(BF_SS_R_files, opts, [subject{i} ' Barefoot Side Lunges Right Side'], BFdir);
%     L_SS_BF = parse_csv_and_plot(BF_SS_L_files, opts, [subject{i} ' Barefoot Side Lunges Left Side'], BFdir);
